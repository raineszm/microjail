...
The `workshop-init-options` capability defines how the `microjail init` command forwards additional SDK selections and base image overrides to Workshop initialization, and how adopt/overwrite modes interact with those flags.
