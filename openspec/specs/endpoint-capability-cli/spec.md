...
For users operating a Microjail project interactively, the project SHOULD provide CLI subcommands for adding and removing Endpoint Capability declarations without manual YAML editing. The commands MUST validate user input, respect Workshop live state for apply, and guard against unsafe mutation of locked Workshops.
