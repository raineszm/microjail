...
The `validate-command` capability enables users to verify the correctness of their microjail configuration before applying it, checking schema conformance, duplicate names, endpoint syntax, and name format without modifying any state.
