# Delta: cli-output-foundation (new capability)

## Purpose

Define the shared CLI output infrastructure: module-level Rich Console singletons and four message helpers used by every CLI command.
